...
public class BoardController {
    ...
    public String boardWritePro(Board board, Model model, MultipartFile file) throws Exception{
        ...
        if(board.getTitle().isEmpty()){
            model.addAttribute("message" , "글작성이 실패 하였습니다.");
        }else {
            Board boardYn = boardService.write(board, file);

            System.out.println("boadrYn ==" + boardYn);
            System.out.println("boadrYn.getId() ==" + boardYn.getId());
